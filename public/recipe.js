...
const toggleCurrentRecipeSaved = async () => {
...
const getImageUrl = (imageName) => {
  ...
  return `https://res.cloudinary.com/${CLOUDINARY_CLOUD_NAME}/image/upload/${RECIPE_IMAGE_FOLDER ? `${RECIPE_IMAGE_FOLDER}/` : ""}${safePublicId}?v=${Date.now()}`;
};
